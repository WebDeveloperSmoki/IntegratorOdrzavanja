...
echo "  </td>
      ...
      <tr>
        ...
        list_restricted_table_entries("users","<option>","</option>",1,0,"username != \"$woassignedto\" AND dptid !=0 ORDER BY username ASC");
        echo "</select>";
        }
        ...
        //list_restricted_table_entries("users","<option>","</option>",1,0,"ORDER BY \"username\" ASC");
        echo "</select>";
        }
 ...
 cellpadding=\"2\" cellspacing=\"2\">
    <tbody>
      <tr>
        ...
        list_restricted_table_entries("lv1","<option>","</option>",1,0,"lv1name != \"$wolv1\"");
        
        echo "</select></td>
        <td style=\"text-align: center;\">System:&nbsp;
        <select name=\"lv2\">";
        ...
        list_restricted_table_entries("lv2","<option>","</option>",1,0,"lv2name != \"$wolv2\"");
        
        echo "</select>
        </td>
        <td style=\"text-align: center;\">Flr:&nbsp;
        <select name=\"lv3\">";
        ...
        list_restricted_table_entries("lv3","<option>","</option>",1,0,"lv3name != \"$wolv3\"");
        ...
        list_restricted_table_entries("lv7","<option>","</option>",1,0,"lv7name != \"$wolv7\"");
...
echo "<br />WO Reporting Area<br />
 ...
 cellpadding=\"2\" cellspacing=\"2\">
    <tbody>
      <tr>
        <td>WO Report:<br>
        <textarea cols=\"100\" rows=\"20\" name=\"woreport\">";
...
function print_order_function($woid,$isservicereport,$isprinthistory){
    echo "<fieldset><legend>WO Information</legend>
  <table style=\"text-align: left; width: 100%;\" border=\"0\" cellpadding=\"2\" cellspacing=\"2\">
    <tbody>
      <tr>
        <td style=\"text-align: right; font-weight: bold;\">WO #:</td>
...
echo "  </td><td style=\"font-weight: bold; text-align: right;\">WO Status:</td>";
  ...
  echo "<fieldset><legend>Functional Location</legend>
  <table style=\"text-align: left; width: 100%;\" border=\"0\"
 cellpadding=\"2\" cellspacing=\"2\">
    <tbody>
      <tr>
  ...
  <fieldset><legend>WO Details</legend>
  <table style=\"text-align: left; width: 100%;\" border=\"0\"
 cellpadding=\"2\" cellspacing=\"2\">
    <tbody>
      <tr>";
...
echo "<fieldset><legend>WO Reporting Area</legend>
  <table style=\"text-align: left; width: 100%;\" border=\"0\"
 cellpadding=\"2\" cellspacing=\"2\">
    <tbody>
      <tr>
    ...
    if ($isprinthistory == "on") {
        echo "<fieldset><legend>WO Change History</legend><table style=\"text-align: left;\" border=\"1\"
